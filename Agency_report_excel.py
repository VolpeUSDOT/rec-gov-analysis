...
#loop through AgencyIDs if more than one
for recarea in AgencyIDs:    
    
    # These tasks (done using PANDAS) are setup to run at the agency level
